...
namespace MasterLogin.Prism.ViewModels
{
    public class ModifyUserPageViewModel : ViewModelBase
    {
        ...
        private bool _isMasterLoginUser;
            ...
            : base(navigationService)
        {
            ...
            //IsMasterLoginUser = User.LoginType == LoginType.MasterLogin;
            //LoadCountriesAsync();
        }
        ...
        public bool IsMasterLoginUser
        {
            get => _isMasterLoginUser;
            set => SetProperty(ref _isMasterLoginUser, value);
        }
        ...
        private async void SaveAsync()
        {
            ...
            MasterLoginMasterDetailPageViewModel.GetInstance().LoadUser();
